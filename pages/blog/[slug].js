            ...
            <LazyMotion features={domAnimation}>
              ...
              <m.div initial="initial" animate="enter" exit="exit">
                <m.div variants={quickFade} className="relative z-20">
                  <Container>
                    <div
                      className="relative max-w-screen-xl py-12 pb-6 mx-auto md:py-20 md:pb-12"
                      id="Treatments"
                    >
                          ...
                          <div className="flex flex-wrap items-center justify-center">
                            <div className="w-full mb-6 md:w-3/5 md:mb-0 md:px-5">
                              <div className="w-full">
                                {blog.heroSubHeading && (
                                  <span className="block mb-2 text-xl italic leading-none text-green-light font-display md:text-2xl lg:text-3xl xl:text-4xl">
                                    {blog.heroSubHeading}
                                  </span>
                                )}
                                <h1 className="text-4xl leading-none md:text-5xl lg:text-6xl xl:text-7xl">
                                  {blog.title}
                                </h1>
                                <small>
                                  <span>

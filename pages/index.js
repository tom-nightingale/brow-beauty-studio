                  ...
                  <Container>
                    ...
                    <div className="relative z-0 pb-12 overflow-hidden bg-gray-200 md:pb-0 md:-mt-8">
                      <div className="flex flex-wrap items-center justify-start xl:justify-end w-full md:min-h-[610px]">
                        ...
                        <div className="relative z-20 h-full max-w-screen-sm p-8 py-12 lg:w-3/5 xl:max-w-none xl:w-1/2 xl:p-12 2xl:p-24">
                          <h1 className="mb-12 text-3xl lg:mb-16 md:text-5xl">
                            {home.heroHeading}
                          </h1>
                    ...
                    <div className="relative z-50 w-32 h-32 mx-auto -mt-12">
                      <Image
                        ...
                        data={{
                          ...home.profilePhoto.responsiveImage,
                          alt: "The Brow &amp; Beauty Studio",
                        }}
                      />
                    </div>
                    ...
                    <div
                      className="relative max-w-screen-xl py-12 mx-auto -mt-12 md:py-20"
                      id="Treatments"
                    >
                      <div className="relative z-10 text-center">
                        <h2 className="lg:mt-[30px] leading-tight">
                          {home.treatmentHeadingTitle}{" "}
                          <span className="block text-2xl font-script lg:text-4xl">
                            {home.treatmentHeadingScript}
                          </span>
                        </h2>
                    ...
                    >
                      ...
                      <div className="md:w-1/2">
                        <div className="mx-auto max-w-[500px]">
                          <Image
                            data={{
                              ...home.contentImage.responsiveImage,
                              alt: "The Brow &amp; Beauty Studio",
                            }}
                          />
                        </div>

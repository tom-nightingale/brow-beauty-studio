...
export default function mobileMenu() {
    ...
    return (
        <>
            ...
            {/* Mobile Menu */}
            <div open={open} className={`fixed top-0 left-0 -z-10 w-full min-h-screen p-4 transition-all duration-200 bg-white ${open ? 'opacity-100 z-40' : 'opacity-0'}`} data-scroll-sticky data-scroll-target="#scroll-container">

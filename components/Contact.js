...
export default function Contact({}) {
  return (
    <div className="px-6 py-16 bg-gray-100 sm:p-8 md:p-12 lg:p-20" id="Contact">
      <Container>
        <p className="mb-[-6px] font-serif text-4xl leading-none text-center text-gray-300 lg:text-5xl lg:mb-[-9px]">
          Contact
        </p>
        ...
        <div className="relative max-w-screen-lg p-8 mx-auto bg-white shadow-lg sm:p-8 md:p-12 lg:p-20">
          <div className="relative">
            ...
            <div className="relative z-20">
              <p className="max-w-screen-sm mx-auto leading-relaxed text-center">
                If you'd like to get in touch to make a booking or ask a
                question please use the form below. If you'd prefer to talk,
                feel free to give me a call directly on{" "}
                <a className="inline-block font-bold" href={`${phoneNumber}`}>

      ...
      <div className="bg-black">
          ...
          <Container>
            <div className="p-8 md:p-12 lg:p-20">
              <div className="flex items-center justify-center">
                <h3 className="mb-0 mr-4 text-3xl text-center text-gray-100 xl:text-5xl">
                  Social
                </h3>
        ...
        <footer className="relative z-50 pb-16 bg-black">
          <Container>
            ...
            <p className="px-8 mt-16 font-serif text-center text-white">
              Asha Mackin - ABT Accredited Course.
            </p>

            <p className="px-8 mt-8 font-serif text-center text-white">
              &copy; Copyright The Brow & Beauty Studio{" "}
